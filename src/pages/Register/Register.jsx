...
import "./style.css";
import enterprise from "../../assets/images/doanh nghiệp.jpg";
...
const Register = () => {
  ...
  return (
    <div className="register">
      {typeForm === 0 && (
        <div className="register-form">
          ...
          <div className="register__middle">
            Để tối ưu tốt nhất cho trải nghiệm của bạn với PGT24h, vui lòng lựa
          ...
          <div className="come-login">
            <button className="btn-come-login" onClick={comeLoginHandler}>
              Đăng nhập
            </button>
          </div>
        </div>
      ...
      {typeForm === 1 && (
        <RegisterEnterprise changeFormHandler={changeFormHandler} />
      )}
